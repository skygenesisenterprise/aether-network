...
The `/docker/` directory contains **containerization infrastructure** for Aether Network Manager, providing production-ready deployment solutions using Docker and Kubernetes.
